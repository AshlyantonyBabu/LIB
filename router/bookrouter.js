...
rt.get("/",function(req,res){
    lib.find({},function(err,result){
        if(err)throw err
            ...
            res.render('books',{nav:[{link:"/",Title:"Home"},{link:"/book",Title:"Book"},{link:'/author',Title:"Author"},{link:"/",Title:"Log Out"}],Pagetitle:"Library",array_book:result}) 
        }
    })
...
lib.findOne(qry,function(err,result){
    ...
    console.log(result)
    res.render('readmr',
    {nav:[{link:"/",Title:"Home"},{link:"/book",Title:"Book"},{link:'/author',Title:"Author"},{link:"/",Title:"Log Out"}],
    Pagetitle:"BOOKS",
    array_book:result}
    );
    }
